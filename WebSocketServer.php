...
abstract class WebSocketServer
{
    ...
    public function create_socket() {
        ...
        socket_bind($this->master, $this->address, $this->port)                      or die("Failed: socket_bind()");
        socket_listen($this->master,20)                               or die("Failed: socket_listen()");
        $this->sockets['m'] = $this->master;
        $this->stdout("Server started\nListening on: $this->address:$this->port\nMaster socket: ".$this->master);

    }


    protected function connecting($php_web_socket, $user) { // mods added $php_web_socket parameter
        // Override to handle a connecting user, after the instance of the User is created, but before
        // the handshake has completed.
        Events::whileConnecting($php_web_socket, $user);        
    }
    ...
    protected function connect($socket) {
        ...
        Events::beforeConnect($this, $user); // mods added this event
        $this->users[$user->id] = $user;
        $this->sockets[$user->id] = $socket;
        $this->connecting($this, $user); // mods added $this parameter
        
        Events::afterConnect($this, $user); // mods added this event
    }

    protected function disconnect($socket, $triggerClosed = true, $sockErrNo = null) {
        $disconnectedUser = $this->getUserBySocket($socket);
        
        Events::beforeDisconnect($this, $disconnectedUser); // mods added this event
        ...
        if ($disconnectedUser !== null) {
            ...
            Events::afterDisconnect($this, $disconnectedUser); // mods added this event
